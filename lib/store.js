 ...
 *
 * @param {IDBRange|Null} range - passes to .openCursor()
 * @param {Function} iterator - function to call with IDBCursor
 * @param {Function} cb - calls on end or error
 */

Store.prototype.cursor = function(range, iterator, cb) {
  var name = this.name;
